...
public interface PipelineService {
   ...
   *         {@link #deletePipelineRecords(String)}
   */
  <T1, T2, T3> String startNewPipeline(
   ...
   *         {@link #deletePipelineRecords(String)}
   */
  <T1, T2, T3, T4> String startNewPipeline(Job4<?, T1, T2, T3, T4> jobInstance,
      T1 arg1,
      T2 arg2,
      T3 arg3,
      T4 arg4,
   ...
   *         {@link #deletePipelineRecords(String)}
   */
  <T1, T2, T3, T4, T5> String startNewPipeline(Job5<?, T1, T2, T3, T4, T5> jobInstance,
      T1 arg1,
      T2 arg2,
      T3 arg3,
      T4 arg4,
